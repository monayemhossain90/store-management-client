...
const SignUp = (props) => {
    let emailRef,firstNameRef,lastNameRef,mobileRef,passwordRef,SignUpBtnRef=useRef();
                                ...
                                <div className="container-fluid m-0 p-0">
                                    <div className="row m-0 p-0">
                                        ...
                                        <div className="col-md-4 p-2 passwordField">
                                            <input onChange={PasswordBtnShowHide} ref={(input)=>passwordRef=input} placeholder="User Password" className="form-control animated fadeInUp" type="password"/>
                                    ...
                                    <div className="row mt-2 p-0">
                                        <div className="col-md-4 p-2">
                                            <button onClick={onRegistration} ref={(button)=>SignUpBtnRef=button} className="btn btn-success mt-3 w-100 float-end animated fadeInUp">SIGN UP</button>
                                        </div>
                                    </div>
                                </div>
