...
import {SignUpVerifyOTPRequest} from "../../../ApiServices/UsersAPIRequest";
                    ...
                    <div className="col-md-7 col-lg-6 center-screen">
                        <div className="card w-90  p-4">
                            <div className="card-body">
                                ...
                                <br/>  <br/>
                                <button ref={(button)=>ProcessingBtnRef=button} onClick={SubmitOTP} className="btn btn-success w-100 animated fadeInUp float-end">Verify</button>
                            </div>
                        </div>
                    </div>
                </div>
